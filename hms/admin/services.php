...
$sql=mysql_query("insert into services(ServiceName,ServiceDate,PatientID,ServiceCharges)values('$servicename','$servicedate','$patientid','$servicecharges')");
if($sql)
{
...
<html lang="en">
	<head>
		<title>Admin | Service Patient</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Patient Service </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add Patient service</h5>
												</div>
												<div class="panel-body">
									
													<form role="form" name="addser" method="post" onSubmit="return valid();">
...
<?php $ret=mysql_query("select * from serviceinfo");
...
{
?>
																<option value="<?php echo htmlentities($row['PatientID']);?>">
																	<?php echo htmlentities($row['PatientID']); ?>
...
<div class="form-group">
					...
					<input type="number" name="ServiceCharges" class="form-control"  placeholder="Enter Service Charge Amount">
														</div>
